                                ...
                                @foreach( $velo as $item)
                                    <tr>
                                     ...
                                     <!-- <td>   <img src="{{ $item->photo }}" > </td> -->
                                        ...
                                        <td>
                                            <a href="{{ url('/velo/' . $item->id) }}" title="View Student"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/velo/' . $item->id . '/edit') }}" title="Edit Zone"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
